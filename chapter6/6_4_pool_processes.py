...
result=100000000   - т.е. результат выдаётся только после того как обсчитан 100_000_000, т.е. порядок строго соблюдается
result=1
result=3
result=5
result=22
...
# т.е. "быстрые результаты возвращаются не сразу - сначала ожидается когда выполнится долгий результат (100_000_000)"
